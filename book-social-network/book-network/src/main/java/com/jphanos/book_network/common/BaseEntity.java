...
@Getter
@Setter
@SuperBuilder // So that the entities inheriting the class will be able to recognize the fields when using the lombok builder class
@AllArgsConstructor
@NoArgsConstructor
@MappedSuperclass // Another important annotation for inheritance to work
