...
import { apporveReturnBorrowBook } from '../fn/book/apporve-return-borrow-book';
import { ApporveReturnBorrowBook$Params } from '../fn/book/apporve-return-borrow-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `apporveReturnBorrowBook()` */
  static readonly ApporveReturnBorrowBookPath = '/books/borrow/return/approve/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `apporveReturnBorrowBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  apporveReturnBorrowBook$Response(params: ApporveReturnBorrowBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return apporveReturnBorrowBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `apporveReturnBorrowBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  apporveReturnBorrowBook(params: ApporveReturnBorrowBook$Params, context?: HttpContext): Observable<number> {
    return this.apporveReturnBorrowBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
